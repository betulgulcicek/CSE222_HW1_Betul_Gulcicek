...
public class Course {
    ...
    public void addTeacher(Teacher t, boolean condition) throws IndexOutOfBoundsException {
    ...
    public void addStudent(Student s, boolean condition) throws IndexOutOfBoundsException {
    ...
    public void addTutor(Tutor t, boolean condition) throws IndexOutOfBoundsException {
    ...
    public void printCourse() throws IndexOutOfBoundsException {
